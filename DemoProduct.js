...
function show()
{
	...
	tx=tx+"<td colspan='6'>";
	tx=tx+"<div style='float:left;text-align:left;padding-left:15px;padding-top:15px;cursor: pointer;' onClick='window.history.back();'>&#124;&larr; Continue buying</div>";
...
function show2(){
	...
	kkk=kkk+"<div style='float:left;text-align:left;padding-left:15px;padding-top:15px;cursor: pointer;' onClick='window.history.back();'>&#124;&larr; Continue buying</div>";
